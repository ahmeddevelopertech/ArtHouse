...
class AccountMove(models.Model):
    ...
    def action_print_journal_entry_receipt(self):
        """Print the enhanced simplified journal entry report"""
        return self.env.ref('journal_entry_printer_cash_receipt.action_report_account_move_custom_simplified_receipt').report_action(self)
